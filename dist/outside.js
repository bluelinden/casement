            ...
            switch (event.data.type) {
                ...
                case `casement-${this.name}-inside-message` && event.data.actionName:
                    ...
                    // if there's no handler, warn the user
                        ...
                        console.warn('Casement Error: Received a message from inside but no handler was set. Make sure to use the outside.on() method to set a handler for this message type.');
                    break;
